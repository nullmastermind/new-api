...
func testChannel(channel *model.Channel, testUserID int, testModel string, endpointType string, isStream bool, byokTestKey string) testResult {
	tik := time.Now()
...
func TestChannel(c *gin.Context) {
	...
	tik := time.Now()
	result := testChannel(channel, testUserID, testModel, endpointType, isStream, byokTestKey)
